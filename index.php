    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/tienda3.jpg" alt="01">
                <div class="carousel-caption">
                    01
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/tienda3.jpg" alt="02">
                <div class="carousel-caption">
                    02
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/tienda3.jpg" alt="03">
                <div class="carousel-caption">
                    03
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">ROJAS MARKET</span> en un sencillo formulario para poder completar tus pedidos</p>
